...
if not os.path.exists('./figures/' + str(option)):
  os.mkdir('./figures/' + str(option))

if os.path.exists('./figures/' + str(option) + '/stock_' + str(option) + end_date + '.png') \
  and os.path.exists('./figures/' + str(option) + '/prediction_' + str(option) + end_date + '.png'):
  
  st.title(str(option) + ' stock price from 01-01-2023 to ' + end_date)
  st.image('./figures/' + str(option) + '/stock_' + str(option) + end_date + '.png')
  st.title(f"Prediction of the next week's price")
  st.image('./figures/' + str(option) + '/prediction_' + str(option) + end_date + '.png')
  ...
  plt.savefig('./figures/' + str(option) + '/stock_' + str(option) + end_date + '.png')
  st.pyplot(plt)
  ...
  plt.ylabel('Close Price USD ($)')
  plt.plot(week)
  plt.savefig('./figures/' + str(option) + '/prediction_' + str(option) + end_date + '.png')
  st.pyplot(plt)